  ...
  sendMessage: async (message: string) => {
    ...
    try {
      ...
      return {
        success: true,
        response:
          "This is a simulated response from the LawXpert AI assistant. In a real implementation, this would be generated by an AI model with knowledge of Indian legal context.",
      };
    } catch (error) {
    ...
    try {
      ...
      const mockHistory = [
        ...
        },
        {
          ...
          role: "assistant",
          content:
            "Right to Information (RTI) Act allows citizens to request information from public authorities. You need to submit an application with a fee of ₹10 to the Public Information Officer of the relevant department. Would you like me to help you draft an RTI application?",
