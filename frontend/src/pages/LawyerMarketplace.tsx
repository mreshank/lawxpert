                                  ...
                                  <div>
                                    <div className="flex items-center gap-1">
                                      ...
                                      {lawyer.is_verified && (
                                        <Badge
                                          variant="secondary"
                                          className="ml-1 h-5 bg-blue-600 text-white"
                                        >
                                          Verified
                                        </Badge>
                                      )}
                                ...
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <div className="flex items-baseline cursor-pointer">
                                      <span className="font-semibold text-lg blur-sm">
                                        ${lawyer.hourlyRate}
                                      </span>
                                      <span className="text-gray-500 text-sm ml-1 blur-sm">
                                        /hour
                                      </span>
                              ...
                              <div className="flex gap-2">
                                ...
                                <TooltipProvider>
                                  <Tooltip>
                                    ...
                                    <TooltipContent>
                                      <p className="w-64 text-xs">
                                        Contact the lawyer first to check
                                        availability and discuss your legal
                                        matter before booking a consultation.
                                      </p>
                                    </TooltipContent>
                                  </Tooltip>
                                </TooltipProvider>
