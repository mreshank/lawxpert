...
const LEGAL_ARTICLES = [
  {
    ...
    level: "beginner",
    description:
      "A comprehensive guide to the Criminal Procedure Code (CrPC), 1973, covering FIR filing, investigation, and trial proceedings.",
    content: `
  ...
  },
  {
    ...
    level: "beginner",
    description:
      "A detailed explanation of the fundamental rights guaranteed to accused persons in the Indian legal system under the Constitution and various statutes.",
    content: `
  ...
  },
  {
    ...
    level: "intermediate",
    description:
      "A comprehensive guide to property ownership types and transfer processes in India under the Transfer of Property Act and related legislations.",
    content: `
  ...
  },
  {
    ...
    level: "intermediate",
    description:
      "Comparative analysis of divorce procedures under Hindu, Muslim, Christian, and Special Marriage Act with recent judicial interpretations.",
    content: `
  ...
  },
  {
    id: 5,
    title:
      "Fundamental Rights under the Indian Constitution: A Comprehensive Guide",
    category: "constitutional",
    subcategory: "fundamental rights",
    level: "beginner",
    description:
      "Detailed explanation of the fundamental rights enshrined in Part III of the Indian Constitution with landmark Supreme Court judgments.",
    content: `
  ...
  },
  {
    id: 6,
    title:
      "Corporate Governance Framework in India: Laws, Regulations, and Best Practices",
    category: "corporate",
    subcategory: "governance",
    level: "advanced",
    description:
      "Comprehensive overview of corporate governance requirements under the Companies Act, SEBI regulations, and international best practices for Indian companies.",
    content: `
  ...
  },
  {
    ...
    level: "intermediate",
    description:
      "Detailed examination of the writ of habeas corpus under Article 32 and 226 of the Indian Constitution with landmark judgments on civil liberties.",
    content: `
  ...
  },
  {
    id: 8,
    title:
      "Real Estate (Regulation and Development) Act: Impact on Property Transactions",
    category: "property",
    subcategory: "regulation",
    level: "intermediate",
    description:
      "Analysis of RERA provisions and their impact on property developers, buyers, and the real estate market in India.",
    content: `
  ...
  },
  {
    ...
    level: "intermediate",
    description:
      "Step-by-step explanation of criminal trial procedure in India under the Criminal Procedure Code with relevant case law.",
    content: `
  ...
  },
  {
    ...
    level: "intermediate",
    description:
      'Analysis of child custody laws under different personal laws and the evolving "best interests of the child" doctrine in Indian courts.',
    content: `
  ...
  },
  {
    ...
    level: "intermediate",
    description:
      "Comprehensive guide to constitutional remedies under Articles 32 and 226, including the five types of writs and their applications.",
    content: `
  ...
  },
  {
    ...
    level: "intermediate",
    description:
      "Detailed analysis of anticipatory bail provisions, procedures, and landmark Supreme Court judgments on pre-arrest bail in India.",
    content: `
  ...
  },
  {
    ...
    level: "beginner",
    description:
      "Comparative study of maintenance provisions under CrPC and different personal laws with recent judicial developments.",
    content: `
  ...
  },
  {
    ...
    level: "advanced",
    description:
      "Step-by-step explanation of the corporate insolvency resolution process under the Insolvency and Bankruptcy Code with case studies.",
    content: `
  ...
  },
  {
    id: 15,
    title:
      "Land Acquisition Process and Fair Compensation under RFCTLARR Act 2013",
    category: "property",
    subcategory: "acquisition",
    level: "intermediate",
    description:
      "Analysis of the land acquisition procedure under the 2013 Act with comparison to the previous regime and judicial interpretations.",
    content: `
...
// Generate categories from LEGAL_ARTICLES
const LEGAL_CATEGORIES = Object.entries(
  LEGAL_ARTICLES.reduce((acc, article) => {
  ...
  return {
    id: category,
    name: nameMap[category] || category.charAt(0).toUpperCase() + category.slice(1) + " Law",
...
const LegalDocumentation = () => {
  ...
  const filteredArticles = LEGAL_ARTICLES.filter((article) => {
    ...
    const matchesSubcategory =
      !subcategoryFilter || article.subcategory === subcategoryFilter;
    ...
    return (
      matchesCategory && matchesSubcategory && matchesLevel && matchesSearch
    );
  });

  // Calculate total pages and paginated articles
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [selectedCategory, subcategoryFilter, levelFilter, searchQuery]);
  ...
  const relatedArticles = selectedArticle
    ? LEGAL_ARTICLES.filter((article) =>
        selectedArticle.relatedArticles.includes(article.id)
      )
    : [];
            ...
            <>
              <div className="mb-8">
                ...
                <p className="text-lawxpert-slate dark:text-gray-300 mt-2">
                  Comprehensive legal resources and guides to help you
                    ...
                    {selectedCategory && subcategories.length > 0 && (
                      <div className="mb-4">
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            setSubcategoryFilter(value === "all" ? null : value)
                          }
                        >
                          <SelectTrigger>
