...
import aiService, { ChatMessage as ChatMessageType, isLegalQuestion } from "@/services/aiService";
...
const legalResources = {
  "Criminal Law": {
    "Indian Penal Code": "https://www.indiacode.nic.in/bitstream/123456789/15289/1/ipc_act.pdf",
    "Code of Criminal Procedure": "https://www.indiacode.nic.in/bitstream/123456789/15272/1/the_code_of_criminal_procedure%2C_1973.pdf",
    "Evidence Act": "https://www.indiacode.nic.in/bitstream/123456789/15351/1/iea_1872.pdf"
  },
  "Civil Law": {
    "Civil Procedure Code": "https://legislative.gov.in/sites/default/files/A1908-05.pdf",
    "Contract Act": "https://legislative.gov.in/sites/default/files/A1872-09.pdf",
    "Specific Relief Act": "https://legislative.gov.in/sites/default/files/A1963-47.pdf"
  },
  "Family Law": {
    "Hindu Marriage Act": "https://legislative.gov.in/sites/default/files/A1955-25.pdf",
    "Special Marriage Act": "https://legislative.gov.in/sites/default/files/A1954-43.pdf",
    "Muslim Personal Law": "https://legislative.gov.in/sites/default/files/A1937-26.pdf"
  },
  "Property Law": {
    "Transfer of Property Act": "https://legislative.gov.in/sites/default/files/A1882-04.pdf",
    "Registration Act": "https://legislative.gov.in/sites/default/files/A1908-16.pdf",
    "Easements Act": "https://legislative.gov.in/sites/default/files/A1882-05.pdf"
  },
  "Constitutional Law": {
    "Constitution of India": "https://legislative.gov.in/sites/default/files/COI.pdf",
    "Representation of People Act": "https://legislative.gov.in/sites/default/files/A1951-43.pdf",
    "Right to Information Act": "https://legislative.gov.in/sites/default/files/A2005-22.pdf"
  }
};

// Common legal queries for quick access
const commonLegalQueries = [
  { en: "What are my rights if arrested?", hi: "गिरफ्तारी पर मेरे क्या अधिकार हैं?", hinglish: "Arrest hone par mere kya rights hain?" },
  { en: "How to file an FIR?", hi: "FIR कैसे दर्ज करें?", hinglish: "FIR kaise file karen?" },
  { en: "Rights in case of domestic violence", hi: "घरेलू हिंसा के मामले में अधिकार", hinglish: "Domestic violence ke case mein adhikar" },
  { en: "Property inheritance laws", hi: "संपत्ति विरासत कानून", hinglish: "Property inheritance ke kanoon" },
  { en: "Motor vehicle accident compensation", hi: "मोटर वाहन दुर्घटना मुआवजा", hinglish: "Motor vehicle accident ka muavza" }
];

// Initial chat history with welcome message
const getInitialChatHistory = (language: 'en' | 'hi' | 'hinglish'): ChatMessageType[] => {
  const welcomeMessages = {
    ...
    hinglish: "Hello! Main aapka LawXpert legal assistant hoon. Aaj main aapke legal queries mein kaise help kar sakta hoon?"
  };
...
const ChatInterface = ({ compact = false }: ChatInterfaceProps) => {
  ...
  const [messages, setMessages] = useState<ChatMessageType[]>(() => getInitialChatHistory(language));
  ...
  const handleSendMessage = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      if (!isApiKeyConfigured()) {
        const apiKeyMessage = language === 'en'
      ...
      const isCommon = commonLegalQueries.some(q => 
        q[language].toLowerCase() === inputMessage.toLowerCase()
      );
      
      try {
        // Get AI response
        const response = await aiService.chatCompletion(recentMessages, language, isCommon);
      ...
      <Tabs defaultValue="chat" value={activeTab} onValueChange={setActiveTab} className="w-full h-full flex flex-col">
        ...
        <TabsContent value="chat" className="flex-1 flex flex-col m-0 overflow-hidden">
          ...
          {!compact && messages.length <= 2 && (
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 border-t border-blue-100">
              <div className="text-sm font-medium text-blue-800 dark:text-blue-300 mb-2">Common Legal Questions:</div>
        ...
        <TabsContent value="documents" className="flex-1 m-0 p-6 overflow-auto bg-gray-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { en: "FIR (First Information Report)", hi: "प्रथम सूचना रिपोर्ट (FIR)", hinglish: "FIR (First Information Report)" },
              { en: "RTI Application", hi: "आरटीआई आवेदन", hinglish: "RTI Application" },
              { en: "Legal Notice", hi: "कानूनी नोटिस", hinglish: "Legal Notice" },
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-medium text-gray-800">{doc[language]}</div>
        ...
        <TabsContent value="resources" className="flex-1 m-0 p-6 overflow-auto bg-gray-50">
          <h3 className="text-lg font-medium mb-4 text-gray-800">
            {language === 'en' 
              ? "Legal Resources" 
              : language === 'hi' 
                    ...
                    <li key={name}>
                      ...
                      >
                        <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm2 10a1 1 0 10-2 0v3a1 1 0 102 0v-3zm2-3a1 1 0 00-1 1v5a1 1 0 102 0v-5a1 1 0 00-1-1zm4-1a1 1 0 10-2 0v6a1 1 0 102 0V8z" clipRule="evenodd" />
                        </svg>
                        {name}
                      </a>
                    </li>
